                    ...
                    fisBuild(fisOpt, 'h5', logname, function(err) {
                        ...
                        fisBuild(fisOpt, 'pc', logname, function(err) {
                            ...
                            if (!localDirLock) {
                                ...
                                var static = './static';
                                serverConfig.uploadOpt.localDir = path.resolve(serverConfig.uploadOpt.localDir, dirFileName,'./static/src/main/webapp/');
                                serverConfig.uploadOpt.remoteDir = path.resolve(serverConfig.uploadOpt.remoteDir);
