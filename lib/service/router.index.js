        ...
        case '/index/build.htm': //打包构建
            ...
            svnCheckout.checkout(req.query.id, logname, function(err, dirFileName, log) {
                if (err) {
                    ...
                    insertPackListData('fail', function() {
                        process.exit();
                    });
                    return;
                ...
                dbHandle.getByConditions('buildInfo', {
                    ...
                    fisBuild(fisOpt, 'h5', logname, function(err) {
                        ...
                        fisBuild(fisOpt, 'pc', logname, function(err) {
                            ...
                            deploy(serverConfig, serverConfig.uploadOpt, function(err) {
                                deployLock = false;
                                insertPackListData('sucess');
                            });
            ...
            // 插入数据到PackList
            function insertPackListData(status, callback) {
